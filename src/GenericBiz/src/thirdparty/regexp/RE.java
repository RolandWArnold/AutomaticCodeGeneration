...
public class RE
{
    ...
    transient StringCharacterIterator search;           // The string being matched against
    ...
    static final int CHARACTER_MIN_RADIX		= 2;
    static final int CHARACTER_MAX_RADIX		= 36;
    static final int CHARACTER_MIN_CODE_POINT	= 0x000000;
    static final int CHARACTER_MAX_CODE_POINT	= 0x10ffff;
    static final char CHARACTER_MIN_VALUE		= '\u0000';
    static final char CHARACTER_MAX_VALUE		= '\uffff';
    
    static final byte CHARACTER_UNASSIGNED                  = 0;
    static final byte CHARACTER_UPPERCASE_LETTER            = 1;
    static final byte CHARACTER_LOWERCASE_LETTER            = 2;
    static final byte CHARACTER_TITLECASE_LETTER            = 3;
    static final byte CHARACTER_MODIFIER_LETTER             = 4;
    static final byte CHARACTER_OTHER_LETTER                = 5;
    static final byte CHARACTER_NON_SPACING_MARK            = 6;
    static final byte CHARACTER_ENCLOSING_MARK              = 7;
    static final byte CHARACTER_COMBINING_SPACING_MARK      = 8;
    static final byte CHARACTER_DECIMAL_DIGIT_NUMBER        = 9;
    static final byte CHARACTER_LETTER_NUMBER               = 10;
    static final byte CHARACTER_OTHER_NUMBER                = 11;
    static final byte CHARACTER_SPACE_SEPARATOR             = 12;
    static final byte CHARACTER_LINE_SEPARATOR              = 13;
    static final byte CHARACTER_PARAGRAPH_SEPARATOR         = 14;
    static final byte CHARACTER_CONTROL                     = 15;
    static final byte CHARACTER_FORMAT                      = 16;
    static final byte CHARACTER_PRIVATE_USE                 = 18;
    static final byte CHARACTER_SURROGATE                   = 19;
    static final byte CHARACTER_DASH_PUNCTUATION            = 20;
    static final byte CHARACTER_START_PUNCTUATION           = 21;
    static final byte CHARACTER_END_PUNCTUATION             = 22;
    static final byte CHARACTER_CONNECTOR_PUNCTUATION       = 23;
    static final byte CHARACTER_OTHER_PUNCTUATION           = 24;
    static final byte CHARACTER_MATH_SYMBOL                 = 25;
    static final byte CHARACTER_CURRENCY_SYMBOL             = 26;
    static final byte CHARACTER_MODIFIER_SYMBOL             = 27;
    static final byte CHARACTER_OTHER_SYMBOL                = 28;
    static final byte CHARACTER_INITIAL_QUOTE_PUNCTUATION   = 29;
    static final byte CHARACTER_FINAL_QUOTE_PUNCTUATION     = 30;
    static final byte CHARACTER_ERROR						= 0xFFFFFFFF;
                    ...
                    switch (opdata)
                    {
                        ...
                        case E_BOUND:
                            {
                                ...
                                if ((isLetterOrDigit(cLast) == isLetterOrDigit(cNext)) == (opdata == E_BOUND))
                                {
                                    return -1;
                                }
                            }
                        ...
                        case E_NSPACE:
                            ...
                            switch (opdata)
                            {
                                case E_ALNUM:
                                case E_NALNUM:
                                    if (!((isLetterOrDigit(c) || c == '_') == (opdata == E_ALNUM)))
                                    {
                                        return -1;
                                    }
                                    break;
                                ...
                                case E_SPACE:
                                case E_NSPACE:
                                    if (!(isWhitespace(c) == (opdata == E_SPACE)))
                                    {
                                        return -1;
                                    }
                                    break;
                ...
                case OP_POSIXCLASS:
                    {
                        ...
                        switch (opdata)
                        {
                            case POSIX_CLASS_ALNUM:
                                if (!isLetterOrDigit(search.charAt(idx)))
                                {
                                    return -1;
                                }
                                break;
                            ...
                            case POSIX_CLASS_BLANK: // JWL - bugbug: is this right??
                                if (!isSpaceChar(search.charAt(idx)))
                                {
                                    return -1;
                                }
                                break;
                            ...
                            case POSIX_CLASS_SPACE:
                                if (!isWhitespace(search.charAt(idx)))
                                {
                                    return -1;
                                }
                                break;
                            ...
                            case POSIX_CLASS_CNTRL:
                                if (getType(search.charAt(idx)) != CHARACTER_CONTROL)
                                {
                                    return -1;
                                }
                                break;
                            ...
                            case POSIX_CLASS_GRAPH: // JWL - bugbug???
                                switch (getType(search.charAt(idx)))
                                {
                                    case CHARACTER_MATH_SYMBOL:
                                    case CHARACTER_CURRENCY_SYMBOL:
                                    case CHARACTER_MODIFIER_SYMBOL:
                                    case CHARACTER_OTHER_SYMBOL:
                                        break;
                            ...
                            case POSIX_CLASS_LOWER:
                                if (getType(search.charAt(idx)) != CHARACTER_LOWERCASE_LETTER)
                                {
                                    return -1;
                                }
                                break;
                            ...
                            case POSIX_CLASS_UPPER:
                                if (getType(search.charAt(idx)) != CHARACTER_UPPERCASE_LETTER)
                                {
                                    return -1;
                                }
                                break;
                            ...
                            {
                                int type = getType(search.charAt(idx));
                                switch(type)
                                {
                                    case CHARACTER_DASH_PUNCTUATION:
                                    case CHARACTER_START_PUNCTUATION:
                                    case CHARACTER_END_PUNCTUATION:
                                    case CHARACTER_CONNECTOR_PUNCTUATION:
                                    case CHARACTER_OTHER_PUNCTUATION:
                                        break;
                            ...
                            case POSIX_CLASS_JSTART:
                                if (!isJavaIdentifierStart(search.charAt(idx)))
                                {
                                    return -1;
                                }
                                break;
                            ...
                            case POSIX_CLASS_JPART:
                                if (!isJavaIdentifierPart(search.charAt(idx)))
                                {
                                    return -1;
                                }
                                break;
     ...
     * @return True if string matched
     */
    public boolean match(StringCharacterIterator search, int i)
    {
    ...
    static boolean isDigit(int ch) {
        int type = getType(ch);
        return (type == CHARACTER_DECIMAL_DIGIT_NUMBER);
    }

    static boolean isLetter(int ch) {
        int type = getType(ch);
        return (((((1 << CHARACTER_UPPERCASE_LETTER) |
            (1 << CHARACTER_LOWERCASE_LETTER) |
            (1 << CHARACTER_TITLECASE_LETTER) |
            (1 << CHARACTER_MODIFIER_LETTER) |
            (1 << CHARACTER_OTHER_LETTER)) >> type) & 1) != 0);
    }
    ...
    static boolean isLetterOrDigit(int ch) {
        ...
        return (((((1 << CHARACTER_UPPERCASE_LETTER) |
            ...
            (1 << CHARACTER_TITLECASE_LETTER) |
            (1 << CHARACTER_MODIFIER_LETTER) |
            (1 << CHARACTER_OTHER_LETTER) |
            (1 << CHARACTER_DECIMAL_DIGIT_NUMBER)) >> type) & 1) != 0);
    }

    static boolean isSpaceChar(int ch) {
        int type = getType(ch);
        return (((((1 << CHARACTER_SPACE_SEPARATOR) |
            (1 << CHARACTER_LINE_SEPARATOR) |
            (1 << CHARACTER_PARAGRAPH_SEPARATOR)) >> type) & 1) != 0);
    }
